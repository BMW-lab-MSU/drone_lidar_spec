...
SOURCE_DIRECTORY_PATH="/ece-bmw-lab/drone-lidar/summer2024/stan-fpv-feather-prop-only/"            # Blackmore
DESTINATION_DIRECTORY_PATH="/home/d86p233/Desktop/BMW-spec/stan-prop-only-h5s/"    # Tempest
