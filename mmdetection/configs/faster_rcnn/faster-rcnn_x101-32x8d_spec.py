...
model = dict(
    backbone=dict(
        ...
        groups=32,
        init_cfg=dict(
            checkpoint='/home/d86p233/Desktop/BMW-spec/mmdetection/checkpoints/resnext101_32x8d-1516f1aa.pth',
            type='Pretrained'),
    ...
    rpn_head=dict(
        anchor_generator=dict(
            ratios=[0.01835, 0.01835, 0.01835],
            scales=[35.22],
            strides=[5, 5, 5, 5, 5],
...
visualizer = dict(
    ...
    vis_backends=[dict(type='LocalVisBackend')])
work_dir = '/home/d86p233/Desktop/BMW-spec/work_dirs/train_task_0'
